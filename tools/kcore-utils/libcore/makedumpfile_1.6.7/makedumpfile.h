...
int closest_pt_load_by_vaddr(unsigned long long vaddr, unsigned long distance);
...
extern int readmem(int type_addr, unsigned long long addr, void *bufptr, size_t size);
