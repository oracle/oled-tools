...
# workloads. Change these to alter thresholds when warnings are printed.
...
# Min MemFree/MemTotal ratio across all NUMA nodes
NUMASTAT_MIN_MEMFREE_PERCENT = 10 * PERCENT

# max(MemFree[Nx])/min(MemFree[Ny]) ratio
NUMASTAT_DIFF_PERCENT = 200 * PERCENT
